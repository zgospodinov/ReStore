...
export default function CheckoutPage() {
    ...
    async function submitOrder(data: FieldValues) {
        ...
        try {
            ...
            const paymentResults = await stripe.confirmCardPayment(basket?.clientSecret!, {
                payment_method: {
                    card: cardElement!,
                    billing_details: {
                        name: nameOnCard
            ...
            if (paymentResults.paymentIntent?.status === 'succeeded') {
                const orderNumberResult = await agent.Orders.create({ saveAddress, shippingAddress });
                setOrderNumber(orderNumberResult);
